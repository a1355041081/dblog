...
<#--                        </ul>-->
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <i class="fa fa-info-circle fa-fw"></i>博主：<small>暂定</small><a  href="${config.weibo}" title="点击查看我的微博" target="_blank" rel="external nofollow">
                                    <i class="fa fa-weibo"></i>
                                </a>
                            </li>
                            <li><i class="fa fa-user-circle fa-fw"></i>职业：<small>暂定</small></li>
                            <li><i class="fa fa-home fa-fw"></i>籍贯：<small>暂定</small></li>
